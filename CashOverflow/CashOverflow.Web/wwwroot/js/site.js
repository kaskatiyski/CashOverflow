...
$(document).ready(function () {
    $('.modal').on('show.bs.modal', function (e) {
        $(".page-content").removeClass('smooth-scrolling');
    })

    $('.modal').on('hidden.bs.modal', function (e) {
        $(".page-content").addClass('smooth-scrolling');
    })
});

$(document).ready(function () {
    $('.no-data').parent().css({'height': '100%'});
});
...
function toggleButtonMenu(id) {
    let menu = $('#' + (id || 'buttonMenu'));
